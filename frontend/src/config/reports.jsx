...
/* ── Report definitions (static config; hooks/store live in the page modules) ─ */
...
export const TATA_CLIQ_SALES_REPORT = {
  key: 'tata-cliq-sales',
  group: 'Sales',
...
export const TATA_CLIQ_RETURN_REPORT = {
...
export const MYNTRA_OMNI_RETURN_REPORT = {
...
export const REPORTS = [
  SALES_REPORT,
  TATA_CLIQ_SALES_REPORT,
  RETURNS_REPORT,
  TATA_CLIQ_RETURN_REPORT,
  MYNTRA_OMNI_RETURN_REPORT,
];
