...
const CARDS = [
  { key: 'total_returns', label: 'Omni Returns', Icon: RotateCcw, color: 'text-violet-500', fmt: formatNumber },
...
export default function MyntraOmniReturnsSummaryCards() {
  const { filters } = useMyntraOmniReturnsFilterStore();
  const { data, isLoading, isFetching, isError, error, refetch } =
    useGetMyntraOmniReturnsSummaryQuery(cleanParams(filters));
