...
import TataCliqReturnsFiltersPanel from '../components/returns/TataCliqReturnsFiltersPanel';
import TataCliqReturnsSummaryCards from '../components/returns/TataCliqReturnsSummaryCards';
import TataCliqReturnsDataTable from '../components/returns/TataCliqReturnsDataTable';

export default function TataCliqReturnsReport() {
      ...
      <motion.div className="space-y-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-bold text-slate-900 dark:text-slate-100">Tata Cliq Return</h1>
          </div>
